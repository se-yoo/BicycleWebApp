...
var nowMenu=0; //0은 메인, 1은 편의시설, 2는 자전거대여 
var bound;
...
window.onload=function () {
	...
	var mapContainer = document.getElementById('map'), // 지도를 표시할 div 
		mapOption = {
		center: new daum.maps.LatLng(37.529226, 126.929288), // 여의도 한강공원
		level: 4 // 지도의 확대 레벨
	};
	...
	var button2 = document.getElementById("helpBt");
...
function handleRefresh2() {
	...
	//148개 있음
	for (var i=1; i<150; i=i+50 )//16번 호출 i=1 j=1000, i=1001 j=2000, i=2001 j=3000,..., i=15001 j=16000 까지
	{
	var j = i + 49;

	var url = "http://openapi.seoul.go.kr:8088/5a71546a53796f6f39334764524e4f/json/SebcBicycleRetal"+$("input[name=lang]:checked").val()+"/"+i+"/"+j;
...
function addMarker(imageSrc, imageSize, imageOption, latitude, longitude, name, address) {
	...
	var content = "<div style='width:100%; height:100%; padding:5px; font-size:0.8em; font-family:맑은고딕;" +
			"color:#fc8f91;'><span style='color:#b88ee3'>시설이름: </span>"
		+ name +'<br>'+"<span style='color:#b88ee3'>주소: </span>"+address +"<br></div>";
